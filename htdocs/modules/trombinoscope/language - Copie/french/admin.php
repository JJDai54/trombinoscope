...
define('_AM_TROMBINOSCOPE_STAT_MEMBERS', "[#%s] Catégorie %s : %s membres actifs et %s membres inactifs");
...
define('_AM_TROMBINOSCOPE_DEFAULT', "Défaut");
define('_AM_TROMBINOSCOPE_CATEGORY_DEFAULT', "Catégorie par défaut");
define('_AM_TROMBINOSCOPE_ACTIF', "Actif");
define('_AM_TROMBINOSCOPE_INACTIF', "Inactif");
define('_AM_TROMBINOSCOPE_CATEGORY', "Catégorie");
define('_AM_TROMBINOSCOPE_MEMBERS_LIST', "Liste des membres");
define('_AM_TROMBINOSCOPE_CATEGORIES_LIST', "Liste des catégories");
define('_AM_TROMBINOSCOPE_CATEGORY_ADD', "Ajouter une catégorie");
define('_AM_TROMBINOSCOPE_CATEGORY_EDIT', "Modifier la catégorie");
define('_AM_TROMBINOSCOPE_PARENT_ID', "Identifiant parent");
define('_AM_TROMBINOSCOPE_NAME', "Nom");
...
define('_AM_TROMBINOSCOPE_WEIGHT', "Poids");
define('_AM_TROMBINOSCOPE_ID', "#");
define('_AM_TROMBINOSCOPE_QUALITY_ADD', "Ajouter une qualité");
define('_AM_TROMBINOSCOPE_QUALITIES_LIST', "Liste des qualités");
define('_AM_TROMBINOSCOPE_QUALITY_EDIT', "Edite");
