...
\define('_CO_TROMBINOSCOPE_LOCALE_MONTH', "janvier,février,mars,avril,mai,juin,juillet,août,septembre,octobre,novembre,décembre,lundi,mardi,mercredi,jeudi,vendredi,samedi,dimanche");
\define('_CO_TROMBINOSCOPE_ENGLISH_MONTH', "January,February,March,April,May,June,July,August,September,October,November,December,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday");
\define('CO_TROMBINOSCOPE_UNACTIVATE', "Désactiver");
\define('CO_TROMBINOSCOPE_ACTIVATE', "Activer");
