...
$templateMain = 'trombinoscope_admin_clone.tpl';
...
switch ($op) {
    ...
    case 'submit':
        ...
        $patterns = [
            \mb_strtolower(\TROMBINOSCOPE_DIRNAME)          => \mb_strtolower($clone),
            \mb_strtoupper(\TROMBINOSCOPE_DIRNAME)          => \mb_strtoupper($clone),
            \ucfirst(\mb_strtolower(\TROMBINOSCOPE_DIRNAME)) => \ucfirst(\mb_strtolower($clone)),
        ];

        $patKeys   = \array_keys($patterns);
        $patValues = \array_values($patterns);
        cloneFileFolder(\TROMBINOSCOPE_PATH);
        ...
        $content = \str_replace('Trombinoscope', \mb_strtolower($clone), $content);
