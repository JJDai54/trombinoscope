...
if ($helper->getConfig('displaySampleButton')) {
    ...
    $adminObject->addItemButton(\constant('_CO_TROMBINOSCOPE_ADD_SAMPLEDATA'), '__DIR__ . /../../testdata/index.php?op=load', 'add');
    $adminObject->addItemButton(\constant('_CO_TROMBINOSCOPE_SAVE_SAMPLEDATA'), '__DIR__ . /../../testdata/index.php?op=save', 'add');
//    $adminObject->addItemButton(\constant('_CO_TROMBINOSCOPE_EXPORT_SCHEMA'), '__DIR__ . /../../testdata/index.php?op=exportschema', 'add');
