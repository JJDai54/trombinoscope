 ...
 * @return bool|null
 */
function xoops_module_update_trombinoscope($module, $prev_version = null)
{
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_trombinoscope_v10($module);
    }

    $ret = trombinoscope_check_db($module);

    //check upload directory
	require_once __DIR__ . '/install.php';
    $ret = xoops_module_install_trombinoscope($module);
 ...
 * @return bool
 */
function update_trombinoscope_v10($module)
{
    global $xoopsDB;
 ...
 * @return bool
 */
function trombinoscope_check_db($module)
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('trombinoscope_images');
    $field   = 'img_exif';
