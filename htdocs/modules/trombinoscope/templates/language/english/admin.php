...
define('_AM_TROMBINOSCOPE_ACTIF', "Active");
define('_AM_TROMBINOSCOPE_ALL', "(*)");
define('_AM_TROMBINOSCOPE_CATEGORIES_LIST', "List of Categories");
define('_AM_TROMBINOSCOPE_CATEGORY', "Category");
define('_AM_TROMBINOSCOPE_CATEGORY_ADD', "Add Category");
define('_AM_TROMBINOSCOPE_CATEGORY_DEFAULT', "Default category");
define('_AM_TROMBINOSCOPE_CATEGORY_EDIT', "Edit Category");
define('_AM_TROMBINOSCOPE_CATEGORY_THEME', "Theme");
define('_AM_TROMBINOSCOPE_CLONE_CONGRAT', "Congratulations! %s was successfully created!<br>You may want to make changes in language files.");
...
define('_AM_TROMBINOSCOPE_DEFAULT', "Default");
...
define('_AM_TROMBINOSCOPE_ID', "Id");
...
define('_AM_TROMBINOSCOPE_MEMBER_ADD', "Add New Member");
define('_AM_TROMBINOSCOPE_MEMBERS_LIST', "List of Members");
define('_AM_TROMBINOSCOPE_NAME', "Name");
define('_AM_TROMBINOSCOPE_PARENT_ID', "Parent id");
define('_AM_TROMBINOSCOPE_QUALITIES_LIST', "List of qualities");
define('_AM_TROMBINOSCOPE_QUALITY', "Quality");
define('_AM_TROMBINOSCOPE_QUALITY_ADD', "Add a quality");
define('_AM_TROMBINOSCOPE_QUALITY_EDIT', "Edit");
define('_AM_TROMBINOSCOPE_STAT_MEMBERS', "[#%s] Category %s: %s active members and %s inactive members");
...
define('_AM_TROMBINOSCOPE_WEIGHT', "Weight");
